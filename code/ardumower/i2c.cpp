...
void I2CScanner(){
  ...
  for(address = 1; address < 127; address++ )
  {
      ...
      if (error == 0)
      {
        ...
        nDevices++;
        switch (address){          
          case 0x0C: Console.print("probably MPU9250/AK8963 - Magnetometer"); break;          
          case 0x1E: Console.print("probably HMC5883L - Accelerometer/Gyro/Magnetometer"); break;          
          case 0x2F: Console.print("probably L3G4200D - Gyro"); break;          
          case 0x30: Console.print("probably MMC5883MA - Accelerometer/Gyro/Magnetometer"); break;          
          ...
          case 0x69: Console.print("probably MPU6050/9150/9250 Acceleromer/Gyro/temperature"); break;          
